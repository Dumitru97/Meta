...
namespace Meta
{
	...
	int set_intersection_cardinal(SortedInputType1* data1, SortedInputType1* end1,
	...
	float JaccardIndexOfSortedSets(const auto& v1, const auto& v2) {
	...
	float JaccardIndexOfSortedSets(const span<int>& v1, const span<int>& v2) {
